...
namespace CustomLoginScreen.Composers
{
    public class CustomLoginScreenApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Custom Login Screen Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<CustomLoginScreenOperationSecurityFilter>();
            });
        }

        public class CustomLoginScreenOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("CustomLoginScreen.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
